...
class GraphBasics
{
    ...
    public static void Main()
    {
        ...
        for (int i = 0; i < e; i++)
        {
            ...
            if (d == 0)
            {
                // Dodawanie krawędzi tylko w jednym kierunku, gdy d == 0
                // Sprawdzamy czy krawędź już nie istnieje w grafie, aby uniknąć powtórzeń
                if (!graph[tokens[1]].Contains(tokens[0]))
                {
